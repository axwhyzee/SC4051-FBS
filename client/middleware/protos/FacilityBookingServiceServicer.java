    ...
    public int _dispatch(byte[] message, byte[] response) throws Exception {
        ...
        switch (method_id) {
			case 1:
				...
				return i[0];
			case 2:
				String facilityName__2__arg = Unmarshaller.unmarshall_string(message, i);
				...
				BookResponse bookFacility__result = service.bookFacility(facilityName__2__arg, user__2__arg, start__2__arg, end__2__arg);
				i[0] = 0;
